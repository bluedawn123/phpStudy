...
$sql = "SELECT * FROM products WHERE isnew=1 ORDER BY reg_date DESC LIMIT 0, 6";
...
$cate_sql = "SELECT * FROM category WHERE step=1";
$cate_result = $mysqli->query($cate_sql);

$cate1Arr = [];
while($cate_data = $cate_result->fetch_object()){
  $cate1Arr[] = $cate_data;
}


/*
category 테이블에서 대분류를 조회해서 변수명 $cate1Arr에 할당
*/
        ...
        <section class="new_arrivals_area section_padding_100_0 clearfix">
            ...
            <div class="karl-projects-menu mb-100">
                <div class="text-center portfolio-menu">
                    ...
                    <?php   
                    if(isset($cate1Arr)){
                      foreach($cate1Arr as $cate){                   
                    ?>
                    <button class="btn" data-filter=".<?=$cate->code;?>"><?=$cate->name;?></button>
                    <?php
                      }
                    }
                    ?>
            ...
            <div class="container">
                <div class="row karl-new-arrivals">
                  ...
                  ?> 
                    ...
                    <div class="col-12 col-sm-6 col-md-4 single_gallery_item <?= $class; ?> wow fadeInUpBig"
                        data-wow-delay="0.2s">
                        <!-- Product Image -->
